...
const CSV_COLUMNS = [
    ...
    { key: 'public_data.variants',                     header: 'variants_json',                            description: 'Масив от варианти в JSON формат. Пример: [{"packaging":"30 капс","flavor":"Ягода","sku":"73101","price":29.99,"ean":"","image_url":"","available":true}].' },
...
function downloadCSVTemplate() {
    ...
    const exampleRow = CSV_COLUMNS.map(({ key, header }) => {
        const examples = {
            ...
            'variants_json':                  '[{"packaging":"30 капс","flavor":"","sku":"","price":29.99,"ean":"","image_url":"","available":true}]',
