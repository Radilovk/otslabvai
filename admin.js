...
const PROMO_EFFECT_OPTIONS = [
  ...
  { id: 'price_below_regular', label: 'Персонална цена: % под клиентска', help: 'Променя цената на всеки артикул — X% под крайната клиентска цена (regular от дистрибутора).' },
  { id: 'price_above_b2b', label: 'Персонална цена: % над доставна', help: 'Променя цената на всеки артикул — X% над доставната цена (цената, на която купувате от Fitness1 / Sila).' },
  { id: 'margin_share', label: '% от маржа (до доставна)', help: 'Отстъпка от маржа между клиентска и доставна цена. 100% = доставна; 50% = половината марж.' },
];
...
function renderPortfolioSettings() {
    ...
    const slidesList = document.getElementById('pf-hero-slides-list');
    if (slidesList) {
