...
const generateProductCard = (product) => {
    ...
    const hasSale = typeof salePrice === 'number' && salePrice > 0 && salePrice < Number(publicData.price);
    const priceHTML = hasSale
        ? `<span class="price-original">${Number(publicData.price).toFixed(2)} €</span><span class="price-sale">${Number(salePrice).toFixed(2)} €</span>`
...
const generateHeroHTML = component => {
    ...
    const getFeatureIconSVG = (iconName) => {
        const icons = {
            mitochondria: `<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            dna: `<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            brain: `<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
const saveNavigationState = (productId = null) => {
    ...
    if (productId) {
        sessionStorage.setItem('lifeLastViewedProduct', productId);
    } else {
        sessionStorage.removeItem('lifeLastViewedProduct');
    }
    ...
    sessionStorage.setItem('lifeCategoryStates', JSON.stringify(categoryStates));
};
                ...
                <div class="container">
                    ...
                    <div class="social-feed-wrapper">
                        ...
                        <div class="social-feed-cta">
                            ...
                            <p>Следете ни за последни новини, оферти и полезни съвети за здравословен начин на живот.</p>
                ...
                <div class="container">
                    ...
                    <div class="social-feed-wrapper instagram-layout">
                        <div class="social-feed-cta">
                            ...
                            <p>Следвайте ни за вдъхновяващо съдържание за здравословен начин на живот, биохакинг и wellness.</p>
                ...
                <div class="container">
                    ...
                    <div class="social-feed-wrapper">
                        ...
                        <div class="social-feed-cta">
                            ...
                            <p>Абонирайте се за редовни видеа, съвети и ексклузивно съдържание за здравословен начин на живот.</p>
        ...
        orderForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch(`${API_URL}/contacts`, {
                    ...
                    body: JSON.stringify({ name, email, phone, message, source: 'life.html' })
                });
...
async function main() {
    ...
    try {
        ...
        try {
            ...
            response = await fetch(`${API_URL}/life_page_content.json`, {
            ...
            response = await fetch('life_page_content_mock.json', {
                cache: 'default'
            });
        ...
        if (isIndexPage) {
            ...
            const lastViewedProduct = sessionStorage.getItem('lifeLastViewedProduct');
            ...
            if (savedScrollPosition || savedCategoryStates || safeLastViewedProduct) {
                ...
                const doRestore = () => {
                    ...
                    if (savedCategoryStates) {
                        ...
                        sessionStorage.removeItem('lifeCategoryStates');
                    }
                    ...
                    if (productCard) {
                        ...
                        sessionStorage.removeItem('lifeLastViewedProduct');
                        sessionStorage.removeItem('lifeScrollPosition');
