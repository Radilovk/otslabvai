...

{
  ...
  "recommended_intake": "Приемайте 1 доза (25ml) дневно, за предпочитане 30-60 минути преди тренировка. В дни без тренировка - сутрин на гладно.",
  "contraindications": "Не е подходящ за бременни и кърмачки. Не превишавайте препоръчителната дневна доза.",
  "additional_advice": "За най-добри резултати комбинирайте L-карнитина с балансирана диета и редовна физическа активност.",
  "faq": [
    {
      "question": "Кога да приемам L-карнитин - преди или след тренировка?",
      "answer": "Най-добре е да го приемете 30-60 минути преди тренировка."
    }
  ],
  "application_type": "Oral",
  "inventory": 50,
  "goals": "отслабване, енергия, спортни резултати",
  "target_profile": "Активни хора, спортуващи редовно",
  "protocol_hint": "Прием 30-60 минути преди тренировка или сутрин на гладно",
  "synergy_products": null,
  "safety_warnings": "Не превишавайте дозата"
}
