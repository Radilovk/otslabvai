...

{
  ...
  "effects": [
    {
      "label": "Подпомага изгарянето на мазнини",
      "value": 80
    },
    {
      "label": "Дава повече енергия през деня",
      "value": 90
    },
    {
      "label": "Ускорява възстановяването след натоварване",
      "value": 70
    }
  ],
  "about_content": {
...
ЕТИКЕТИ ЗА ЕФЕКТИ (effects.label) — пиши на ясен български, конкретно и разбираемо:
✅ Използвай глаголи с ясен резултат: „Ускорява метаболизма“, „Подобрява перисталтиката“, „Укрепва имунитета“, „Намалява умората“, „Подобрява качеството на съня“
❌ Избягвай общи и блудкави фрази: „метаболитна подкрепа“, „енергиен метаболизъм“, „клетъчно здраве“, „обща подкрепа“, „имунна подкрепа“, „подкрепа за...“
✅ Всеки етикет трябва да казва какво точно прави продуктът за потребителя, не медицински жаргон
